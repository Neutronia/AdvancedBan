...
-- #   }
-- #   { init_device_ban
CREATE TABLE IF NOT EXISTS device_ban (deviceId VARCHAR(30) NOT NULL PRIMARY KEY, expireAt BIGINT NOT NULL, reason VARCHAR(255) NOT NULL, issuer VARCHAR(30) NOT NULL)
-- #   }
-- #   { init_player
